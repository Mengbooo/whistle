...
- 保持内容冷静、中立、克制、反噪音
- 语言要像正常中文编辑写作，句子自然、顺口、具体。日报开头要像编辑在和读者打招呼：可以用“早上好，今天有几件事值得留意：”“先看几条新变化。”，也可以直接从最重要的新闻切入；每期变换句式，不要固定复用同一个开头。总述可以用冒号引出 2 到 4 个并列事实，再用自然短句说明它们之间的联系，不要写成生硬的项目清单。不要使用一眼 AI 的抽象套话，例如“今天的主线是”“今天有几类事值得放在一起看”“继续向……下沉”“可执行工作流”“反向约束”“行业图景”“赋能”“加速重塑”“范式转移”“生态闭环”“关键抓手”。
...
- 每条核心内容先保留来源事实，再给出解释：先用 1 到 2 句交代原新闻的关键事实和上下文，再用 1 到 3 句解释这件事到底是什么、为什么会影响行业、产品形态、工作方式、商业模式、分发渠道或监管边界。不要把原始新闻改写成只有判断、没有事实依据的短评。
- 解读要比事实复述更直白，可以稍微通俗一点，让缺少上下文的读者也能看懂“这是个什么事、为什么值得知道、它改变了什么”。但语气仍然是专业分析师，不要写成鸡汤、标题党、短视频口播或过度简化的科普。
- 不要在 item 里写行动建议，不要使用“团队应该/可以/建议/需要/值得立刻/今日可以采取”等面向执行的措辞。也不要写“对产品、运营和设计团队”“对研发团队”“创业者可以”等按岗位分发的句子。只解释事件本身，不告诉任何人该怎么做。
...
- 如果某条信息具备明显趋势信号，可以自然补一句基于事实的影响说明；不要每条都硬加预测。
- 影响说明要贴着事件本身展开，可以说明它可能改变的产品形态、工作方式、商业模式、分发渠道或监管边界，但不要写成咨询报告式建议。
- 文章首部 `summary` 可以写长一点，建议 220 到 360 字。它要纵览全文，先用自然中文说清今天发生了哪些主要事情，再说明这些事之间有什么相似处、彼此如何关联、可能带来什么影响。不要写成“今天的主线是……”“对团队来说……”这类模板句；不要用“下沉、反向约束、行业图景”这种抽象词。

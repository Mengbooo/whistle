...
- 写作必须像正常中文编辑写作，句子自然、顺口、具体。日报开头要像编辑在和读者打招呼：可以用“早上好，今天有几件事值得留意：”“先看几条新变化。”，也可以直接从最重要的新闻切入；每期变换句式，不要固定复用同一个开头。总述可以用冒号引出 2 到 4 个并列事实，再用自然短句说明它们之间的联系，不要写成生硬的项目清单。不要使用一眼 AI 的抽象套话，例如“今天的主线是”“今天有几类事值得放在一起看”“继续向……下沉”“可执行工作流”“反向约束”“行业图景”“赋能”“加速重塑”“范式转移”“生态闭环”“关键抓手”。
...
```json
{
  ...
  "summary": "一段 220 到 360 字的今日总述，纵览全文。开头用自然、亲和且每期有变化的编辑口吻，可以是“早上好，今天有几件事值得留意：”，也可以直接从最重要的新闻切入；随后用 2 到 4 个并列事实和自然短句说清今天发生了什么、它们有什么关联和可能影响，不要写成固定模板或生硬的建议清单。不要用“今天的主线是”“今天有几类事值得放在一起看”“下沉”“反向约束”“行业图景”等 AI 套话。",
